...
public class MenuService implements BaseService<MenuResource> {
    ...
    public MenuResource save(MenuResource entity) throws GenericException {
        ...
        return Optional.of(repository.save(menu)).map(menuConverter::convertToEntityAttribute).orElseThrow(() -> new RuntimeException("Could not create the menu."));
    ...
    public void delete(Long id) {
        Menu existingMenu = repository.findById(id)
                .orElseThrow(() -> new RuntimeException("Could not find the menu."));
